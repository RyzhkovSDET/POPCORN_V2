...
def strength_label(strength: int) -> str:
    """Словесная подпись силы уровня вместо голого числа касаний."""
    labels = {1: "слабая", 2: "средняя", 3: "хорошая", 4: "сильная"}
    return labels.get(strength, "магнитная")  # 5+ касаний -- уровень притягивает цену
